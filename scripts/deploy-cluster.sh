...
echo "[DEPLOY] Deploying ATP to AWS..."
...
echo "[S3] Creating S3 bucket for kops state..."
...
echo "[KOPS] Creating kops cluster..."
...
# Deploy cluster
echo "[AWS] Deploying to AWS (this will take 5-10 minutes)..."
kops update cluster --name $CLUSTER_NAME --yes

# Wait for cluster to be ready
echo "[WAIT] Waiting for cluster to be ready..."
kops validate cluster --wait 10m

# Step 3: Install Sealed Secrets
echo "[SEALED-SECRETS] Installing Sealed Secrets controller..."
...
if ! command -v kubeseal &> /dev/null; then
  echo "[INSTALL] Installing kubeseal CLI..."
...
echo "[SECRETS] Creating sealed secrets..."
